...
./build.sh
```
البته بیلد کردن کلاینت سی‌پی‌پی نیاز به نصب دیپندنسی‌هایی دارد که دستورات نصب آن‌ها در [ریپو کلاینت سی‌پی‌پی](https://github.com/SharifAIChallenge/AIC22-Client-Cpp) موجود است. 

### Windows
برای اجرای بیلد کردن کلاینت روی سیستم‌عامل ویندوز، باید از wsl استفاده کنید. برای نصب wsl از [داکیومنت رسمی ماکروسافت](https://docs.microsoft.com/en-us/windows/wsl/install) استفاده کنید. با نصب این ابزار شما امکان استفاده از ترمینال لینوکس در ویندوز خود را پیدا می‌کنید و می‌توانید بقیه مراحل را مطابق بیلد لینوکس پیش بروید. 
...
پس از unzip کردن فایل گرافیک با توجه به سیستم‌عاملتان، با کلیک کردن بر روی فایل AIC_Graphic_Linux.x86_64 یا AIC22-Graphic.exe  ی برنامه گرافیک بازی را باز کنید و با کلیک روی دکمه‌ی Choose Game File، فایل server.log تولید شده توسط سرور را به آن بدهید.
...
+ فایل server.log که در گرافیک در حال اجرای آن بوده
