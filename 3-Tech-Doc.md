...
برای اجرای سرور، باید از java 16 به بالا استفاده کنید.
 ...
 سرور یک فایل yaml در بخش resource به اسم game.yml دارد که کانفیگ بازی در آن قرار دارد این بخش به صورت خودکار باید تولید شود و شامل اصلاعات بازی کنان که در agents قرار دارد . Agents ارایه ای از بازکنان است که شامل token و اطلاعات اولیه ی آن‌ها است سپس graph بازی در آن قرار میگیرد که شامل node ها همان خانه‌های بازی و path ها مسیر های بازی است و کانفیگ های مربوط به maxTurn و پولی که در پایان هر turn به کلاینت ها میرسد را دارد همین‌طور اطلاعات مروبط به هزینه ی چت ها و turn هایی که در آن جای دزد ها مشخص می‌شود بعد از ساخت این yml به کلاینت های هر شرکت کننده یکی از این token ها داده می‌شود و yml کلاینت ها هم ساخته می‌شود سپس بازی اجرا می‌شود بنابراین کلاینت ها با استفاده از token ای که در yml آن‌ها قرار گرفته خودشان را به سرور متصل میکنند و سرور هم به آن‌ها اطلاعاتشان را میدهد.

ابتدا آخرین نسخه ریلیز سرور را از [این‌جا](https://github.com/SharifAIChallenge/AIC22-Game/tree/main/server) دانلود کنید (فایل server.jar).  
